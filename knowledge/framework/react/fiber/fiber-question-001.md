...
![](https://pic1.zhimg.com/80/v2-d8f4598c70df94d69825f11dfbf2ca2c_1440w.png) 破解方式——分片。 有了分片之后，更新过程的调用栈如下图所示，中间每一个波谷代表深入某个分片的执行过程，每个波峰就是一个分片执行结束交还控制权的时机。![](https://pic1.zhimg.com/80/v2-78011f3365ab4e0b6184e1e9201136d0_1440w.png) 实现使用的API：

## requestIdleCallbackQ.为什么引入Fiber架构？原架构有何不足？
...
## React Hook基于Fiber架构，hook的复用是如何实现的？
